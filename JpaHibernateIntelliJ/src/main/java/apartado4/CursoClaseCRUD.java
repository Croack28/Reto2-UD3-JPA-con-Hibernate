...
public class CursoClaseCRUD {
	...
	}public static void query6MeduasSumas(){
...
// Consulta para calcular la duración promedio de clases activas
	...
	}public static void query5Between(){
	...
	}public static void query4CriteriosAproximados(){
	...
	}public static void query3Ordenada(){
	...
	public static void query2Where(){
	...
	public static void query1AlgunosCampos(){
	...
	public static void poblarBaseDatos() throws ParseException {
